...
(One URI per line. To include all child terms of  a source term (extract the whole branch), enter &quot;includeAllChildren&quot; in the line next to the source term)</strong><br>
		      ...
		      <input type="hidden" name="termLbl1" id="termLbl1">
		      </td>
		    </tr>
		  <tr>
...
<p><span class="header_darkred">3. Remote Ontofox access without using the Ontofox web page:</span> 
	    <br/>
    <span style="margin-left:16px;"> For those users who like to access Ontofox programmatically without coming to Ontofox web page, we have generated a new php script: http://ontofox.hegroup.org/service.php.  An example  command line code to use  this script is here: &quot;<strong>curl -s -F file=@"/tmp/input.txt" -o /tmp/output.owl http://ontofox.hegroup.org/service.php</strong>&quot;. </span>
    <br/>
    <span style="margin-left:16px;"> Note  that in the above curl command, the &ldquo;-s&rdquo; is an option for silent mode. It will avoid returning any HTTP status/message from CURL. If the command with  &ldquo;-s&rdquo; does not work out with you, you may remove the option and test again. <br/>
    <span style="margin-left:16px;"> A Perl script (or a program based on Java or other language) can also be developed. In this case, a user will need use &quot;put&quot; to access this page.</span>
</p>
<p><strong>Please Cite Publication: </strong>Xiang Z, Courtot M, Brinkman RR, Ruttenberg A, He Y. <a href="http://www.biomedcentral.com/1756-0500/3/175">OntoFox: web-based support for ontology reuse</a>. <em>BMC Research Notes</em>. 2010, <strong>3:</strong>175. [PMID: <a href="http://www.ncbi.nlm.nih.gov/pubmed/20569493">20569493</a>] (Note: Check out  <a href="references.php">more references</a>).</p>
