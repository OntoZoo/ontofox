...
UNION
{
?nodeID owl:annotatedSource ?s.
?nodeID owl:annotatedProperty <$annotation_iri>.
?nodeID owl:annotatedTarget ?o3.
...
'. $strOutput;
		...
		system("java -cp .:./libs/* org.hegroup.ontofox.OWLReformat $userfiles/$fileName.settings");
...
if ($vali->getErrorMsg()=='') {
	if (sizeof($fileNames)>1) {
		...
		system("java -cp .:./libs/* org.hegroup.ontofox.OWLMerge $userfiles/$finalFile.settings");
