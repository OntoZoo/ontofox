...
<p><strong>Please Cite OntoFox (http://ontofox.hegroup.org): </strong></p>
<p>Xiang Z, Courtot M, Brinkman RR, Ruttenberg A, He Y. <a href="http://www.biomedcentral.com/1756-0500/3/175">OntoFox: web-based support for ontology reuse</a>. <em>BMC Research Notes</em>. 2010, <strong>3:</strong>175. </p>
<p>&nbsp;</p>
<p><strong>Other Related References:</strong></p>
<p>Courtot M, Gibson F, Lister AL, Malone J, Schober D, Brinkman RR, Ruttenberg A. MIREOT: the Minimum Information to Reference an External Ontology Term. <a href="http://icbo.buffalo.edu/">ICBO 2009</a>.</p>
<p>MIREOT (Minimal information to reference external ontology terms): <a href="http://obi-ontology.org/page/MIREOT">http://obi-ontology.org/page/MIREOT</a>. </p>
<p>Ruttenberg A, Rees JA, Samwald M, Marshall MS. <a href="http://www.ncbi.nlm.nih.gov/pubmed/19282504">Life sciences on the Semantic Web: the Neurocommons and beyond</a>. <em>Brief Bioinform</em>. 2009 Mar;10(2):193-204. PMID: 19282504. </p>
<p>Smith B, Ashburner M, Rosse C, Bard J, Bug W, Ceusters W, Goldberg LJ,  Eilbeck K, Ireland A, Mungall CJ; OBI Consortium, Leontis N,  Rocca-Serra P, Ruttenberg A, Sansone SA, Scheuermann RH, Shah N,  Whetzel PL, Lewis S. (2007). <a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&amp;db=pubmed&amp;dopt=Abstract&amp;list_uids=17989687">The OBO Foundry: coordinated evolution of  ontologies to support biomedical data integration</a>. <em>Nat Biotechnol</em> 25 (11): 1251-5. PMID 17989687.</p>
<p>&nbsp;</p>
<!-- InstanceEndEditable -->
</div>
<div id="footer">
