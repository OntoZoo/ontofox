...
<form action="do_upgrade2.php" method="post" enctype="multipart/form-data" target="_blank">
...
<p>&nbsp;</p>
      <strong style="margin-left:16px;">(1) Please specify the  target files:</strong></td>
  </tr>
  <tr>
    <td style="padding-left:16px">Upload zip file:
      <input name="target_owl" type="file" id="target_owl" size="60"></td>
  </tr>
  <tr>
    <td align="center" style="padding-top:12px"><input type="submit" name="Submit1" value="Get  Output File" />
