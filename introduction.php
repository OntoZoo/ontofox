...
<p> Ontofox also develops a new SPARQL-based ontology term extraction algorithm. Our algorithm allows extraction of external ontology terms relevant to a given set of signature terms, implemented by SPARQL query of associated RDF triples. Effectively the algorithm takes the union of the concise bounded description (Reference: <a href="http://www.w3.org/Submission/CBD/">http://www.w3.org/Submission/CBD/</a>) of the terms. This algorithm  extracts additional terms that are not in the is-a hierarchies of signature terms. This SPARQL modularization algorithm is execuated in Ontofox after a user selects the setting &ldquo;includeAllAxioms&rdquo; or &quot;includeAllAxiomsRecursively&quot;. Current modularization algorithms use in-memory representations that   require excessive memory for ontologies such as NCBI Taxonomy. In   contrast, the SPARQL-based approach is highly scalable.  Since the ontology modularization is frequently used, in June 2011, we have also added <a href="http://ontodog.hegroup.org">Ontodog</a>, an Ontofox-based specific ontology modularization program in the Ontofox web server.  </p>
