...
</span><span style="margin-left:16px;"></span>Step1:</strong> Specify a source ontology from which  ontology terms will be retrieved and used for importing into a new target ontology. You can select an ontolgy from the dropdown list (Fig 1.1) or enter the URL and the SPARQL endpoint in the textarea (Fig 1.2)</p>
...
<p>Fig 1.2</p>
<p><strong><span style="margin-left:16px;"></span>Step 2:</strong> Enter the URI of the low level source term you wish to import. Alternatively, you can search a term by entering keywords related to the term (term label or synonyms, partial words supported) in the input box. After  you type  three or more characters in the searching box, a list of terms which match  your input will be dynamically added to the dropdown list below the input box (Fig 2.1). Aftern a term is selected or fully typed, the ontology ID for this term will be shown in grey color. If the &quot;Detail&quot; button is clicked, the detailed information about the term will be shown in a seperate page (Fig 2.2). For some of the ontologies, the detail pages are links to the individual ontolog browsers provided by their corresponding developers. Others are linked to our OntoBee ontology browser (<a href="http://ontobee.hegroup.org/">http://ontobee.hegroup.org/</a>). Multiple terms can be added one by one. </p>
<p>Once you find a  term you want, click &quot;Add&quot; button, the term URI and its label will be added to the textarea (Fig 2.3).</p>
...
<p>Fig 2.3</p>
<p><strong><span style="margin-left:16px;"></span>Step 3:</strong> Enter the URI of the top level source term that you wish to import. You can use the same technique to search the terms as shown in step 2 (Fig 3.1). </p>
<p>Once you find an ontology term, click &quot;Add&quot; button. The term URI and its label will then be added automatically to the textarea (Fig 3.2). You can enter the target direct superclass URI for the term (Fig 3.3) or remove the text &quot;subClassOf&quot; if don't want to specify the target direct superclass for the term.</p>
<p></p>
